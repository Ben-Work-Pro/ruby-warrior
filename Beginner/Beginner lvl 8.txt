#Reprise de l'algorithme permettant au guerrier de prendre de meilleures décisions
#Ajout d'une fonction permettant de regarder les 3 cases devant le guerrier et determiner la nature du prochain évènement qu'il va recontrer (enemie ou prisonnier)
#Ajout d'une fonction permettant d'attaquer à distance
#Ce code à été initialement réalisé pour le niveau 9
