#Modification de l'algorithme pour permettre au guerrier de traverser les objectifs l'empêchant d'aller désamorcer les bombes
...
class Player
  ...
  def choose_strategy_enemy()
    if (@bomb == true)
      if enemy_in_the_way()
        if (@enemy_nb == 1)
          attack(@warrior.direction_of(get_bomb_pos))
        else
