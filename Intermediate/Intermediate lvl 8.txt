#Ajout d'une fonction pour lancer une bombe sur les ennemis
#Ajout d'une fonction permettant de choisir le type d'attaque du guerrier (épée ou bombe) en fonction de la situation
...
class Player
  ...
  def choose_strategy_alone()
    if (@bomb == true)
      if (@capture_nb > 0 && @warrior.feel(@warrior.direction_of(get_bomb_pos)).captive?)
